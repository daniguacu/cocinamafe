...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.op1nav:
                T1.setText("Escogió la opción de crear usuario");
                //lanza la activity del formulario
                Intent AFR=new Intent(this,registro.class);
                startActivity(AFR);
                break;
            case R.id.op2nav:
                T1.setText("Escogió la opción de comprar");
                Intent AIS=new Intent(this,iniciarsesion.class);
                startActivity(AIS);
                break;
        }
        DrawerLayout drawer=(DrawerLayout)findViewById(R.id.drawer_layout);
